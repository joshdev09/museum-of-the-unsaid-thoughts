...
import RantWall from "./RantWall"; // Added this so your new component works!
import "../App.css";
...
function MainScreen() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="relative min-h-screen px-6 py-10 md:px-12">
        {/* Header row */}
        <div className="flex flex-row items-center justify-between mb-8">
          <h1 className="text-[#333333] patrick-hand-regular text-2xl md:text-3xl">
            Rant Collections
          </h1>
          <button
            onClick={() => navigate("/rant/write")}
            className="p-2 px-4 border-[#333333] transition-colors duration-300 ease-in-out hover:bg-[#333333] hover:text-white border-2 rounded-full patrick-hand-regular flex justify-center items-center gap-2 cursor-pointer text-sm"
          >
